...
st.title("NishantGPT - Nishant's resume bot")
st.image("images/about.jpg", use_column_width=True)
with st.expander("⚠️Disclaimer"):
	st.write("""This bot is a LLM trained on GPT-3.5-turbo model to answer questions about Nishant's professional background and qualifications. Your responses are recorded in a database for quality assurance and improvement purposes. Please be respectful and avoid asking personal or inappropriate questions.""")
...
data_source = path+"/data/about_nish.csv"
pdf_source = path+"/data/Nishant_CV.pdf"
...
def conversational_chat(query):
	with st.spinner("Thinking..."):
    	result = chain({"system":
    	"You are a Resume Bot, a comprehensive, interactive resource for exploring Nishant's background, skills, and expertise. Be polite and provide answers based on the provided context only. Only answer questions relevant to Nishant and his work experience. Answer question if there are ONLY regarding Nishant. If the questions is not relevant to Nishant, reply that you are a Resume bot. You can make up projects with the skills and projects I have if the question requests a skill set related to Machine Learning, Database management or Computer sciences.",
                    	"question": query,
	...
	if is_valid_json(result["answer"]):         	 
    	...
    	data = json.loads('{"answered":"false", "response":"Hmm... Something is not right. I\'m experiencing technical difficulties. Try asking your question again or ask another question about Nishant\'s professional background and qualifications. Thank you for your understanding.", "questions":["What is Nishant\'s professional experience?","What projects has Nishant worked on?","What are Nishant\'s career goals?"]}')
	...
	if ('I am tuned to only answer questions' in response) or (response == ""):
    	full_response = """Unfortunately, I can't answer this question. My capabilities are limited to providing information about Nishant's professional background and qualifications. If you have other inquiries, I recommend reaching out to Nishant on [LinkedIn](https://www.linkedin.com/in/Nishantd1997/). I can answer questions like: \n - What is Nishant's educational background? \n - Can you list Nishant's professional experience? \n - What skills does Nishant possess? \n"""
    	store_conversation(st.session_state["uuid"], query, full_response, answered)
	else:
    	markdown_list = ""
    	for item in questions:
        	markdown_list += f"- {item}\n"
    	full_response = response + "\n\n What else would you like to know about Nishant? You can ask me: \n" + markdown_list
    	store_conversation(st.session_state["uuid"], query, full_response, answered)
...
if "messages" not in st.session_state:
	...
	with st.chat_message("assistant"):
    	...
    	welcome_message = """
        	Welcome! I'm **Resume Bot**, a virtual assistant designed to provide insights into Nishant ‘s background and qualifications.
       	 
        	Feel free to inquire about any aspect of Nishant's profile, such as his educational journey, internships, professional projects, areas of expertise in data science and AI, or his future goals.
...
if prompt := st.chat_input("Ask me about Nishant"):
